...
![Closing Prices](docs/media/close_rets.png)
...
![Returns PDF](docs/media/returns_pdf.png)
...
|----------------------------------|-----------------------------------------|
| ![Correlation Matrix](docs/media/rets_corr_matrix.png) | ![Hierarchical Clustering](docs/media/hierarchial_cluster_corr.png) |
